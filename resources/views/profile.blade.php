        ...
        <div class="col-md-6 mx-auto">
            <div class="card p-5">
               <div class="text-center">
                   <img src=" {{asset('storage/'. auth()->user()->image)}} " alt=""  width="82px"  height="82px" class="rtl">
                   <h3 class="m-4 font-weight-bold">
                       {{auth()->user()->name}}
                   </h3>
               </div>
            <div class="card-body text-right">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" id="passwrd" class="form-control" >
                    @error('password')
                    <div class="text-danger">
                      <small> {{$message}} </small>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password-confirmation" id="passwrd-confirmation" class="form-control" >
...
@enderror 
               ...
               <div class="form-group d-flex mt-5 flex-row-revese">
